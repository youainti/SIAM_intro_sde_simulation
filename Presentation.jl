...
# ╔═╡ dcb199df-c7be-4093-a106-01fcdbc94057
...
$v = \int_0^T  \lambda e^{-\lambda t} \int_0^t p e^{-\rho \tau} d\tau  dt$
...
# ╔═╡ fca734f0-fb4d-4cae-a8d6-ec7a33759ff1
begin
...
# ╔═╡ 395d7721-0c6e-4d71-8bfb-7371431a884b
begin
	#setup symbols
	@parameters τ y
	@variables f(..)
	...
	equation = Dτ(f(τ,y)) + θ*(μ-y)*Dy(f(τ,y)) + (σ^2)/2 * Dyy(f(τ,y)) ~ -ρ*τ*f(τ,y)

	boundary_conditions = [
		#Final condition f(T,y) = g(y)
		Dτ(f(T,y)) ~ y*λ*exp(-λ*T)
		,f(τ,0) ~ 0 #no probability of a price equal to zero
	...
	Δy = 10 #just to get the error to show up easily
	discrete = MOLFiniteDifference([y=>Δy],τ;centered_order=2)
end

# ╔═╡ 90ea0280-02d3-46cc-bef5-8afd2e8df7ca
md"""
Submit an error?
"""

# ╔═╡ c5912dad-6ae5-4635-bab8-97e6666d54b6
problem = discretize(fk,discrete)

# ╔═╡ f1928f12-297f-4202-85e5-10c23e921f3c
...
[[DiffEqOperators]]
deps = ["BandedMatrices", "BlockBandedMatrices", "DiffEqBase", "DomainSets", "ForwardDiff", "LazyArrays", "LazyBandedMatrices", "LinearAlgebra", "LoopVectorization", "ModelingToolkit", "NNlib", "NonlinearSolve", "Requires", "RuntimeGeneratedFunctions", "SciMLBase", "SparseArrays", "SparseDiffTools", "StaticArrays", "SuiteSparse", "SymbolicUtils"]
git-tree-sha1 = "ef3a13cb31be8bab699a855ad69740fd175cca7f"
