...
# ╔═╡ 6428b06a-3c38-11ec-1d99-bd13b5a68039
using ModelingToolkit, StochasticDiffEq, Plots,PlutoUI

# ╔═╡ b46bcaff-0dcd-490f-9c13-e164e05e10a3
# Define some variables
@parameters σ ρ a₋₁ a₂ a₀ a₁ r

# ╔═╡ f15fcaa7-3d7c-491f-9ed1-847ca4e64d50
@variables t x(t)

# ╔═╡ 29bde869-eb9e-41ea-b290-24b698fff8c9
D = Differential(t)

# ╔═╡ 593567d4-f554-45a1-b7b1-84c5eaa6e20f
μ = [D(x) ~ a₋₁/x - a₀ + a₁*x - a₂*x^r]

# ╔═╡ 4894597b-ce6b-46fd-8035-5d3a1ab7a3f8
Σ = [σ*x^ρ]

# ╔═╡ 225285ca-8caa-4a90-9258-071a71eff1f3
@named ait_sahalia = SDESystem(μ,Σ,t,[x],[σ,ρ,a₋₁,a₂,a₀,a₁,r])

# ╔═╡ 652948d0-9b24-4dc4-905e-47c8bb47b945
initializations = [
    x => 1.0
]

# ╔═╡ dc9d8d53-65bd-477b-a224-8043e475289f
md"""
σ = $(@bind sigma PlutoUI.Slider(1:0.1:9))

ρ = $(@bind rho PlutoUI.Slider(1:0.1:9))

a_{-1} = $(@bind aneg1 PlutoUI.Slider(1:9))

a_0 $(@bind a0 PlutoUI.Slider(1:0.1:9))

a_1 $(@bind a1 PlutoUI.Slider(1:0.1:9))

a_2 $(@bind a2 PlutoUI.Slider(1:0.1:9))

r = $(@bind rr PlutoUI.Slider(1:0.1:9))

"""

# ╔═╡ e20987d3-f5c9-4394-9a7a-e1dc59641260
param_map = [
    σ => sigma,
    ρ => rho,
    a₋₁ => aneg1,
...
# ╔═╡ a64351d2-cba6-4ccd-87e5-3bb1e93cc2c8
prob = SDEProblem(ait_sahalia,initializations,(0.0,1.0),param_map);

# ╔═╡ d5bd3ab7-7c5f-4a4a-809d-4f8d674a9ebc
#Solve using Euler-Maruyama
sol = solve(prob,EM(), dt=1e-4, adaptive=false);

# ╔═╡ 7e54d79b-31fb-47e6-af03-95c685131a58
plot(sol)

# ╔═╡ c8e4860f-2ec2-4cb1-8163-0080b376dec1
sol2 = solve(prob,EM(), dt=1e-4, adaptive=false);

# ╔═╡ 3793945b-4070-451b-9567-64593a7005e1
